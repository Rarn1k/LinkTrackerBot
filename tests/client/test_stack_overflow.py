...
async def test_get_question_success(
    ...
    question_id = "123"
    client = StackOverflowClient(api_key="test_key", settings=settings)
...
async def test_get_question_no_items(mocker: MockerFixture, settings: ClientSettings) -> None:
...
async def test_get_question_not_found(mocker: MockerFixture, settings: ClientSettings) -> None:
